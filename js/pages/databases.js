...
initAuthGuard(function(user) {
  ...
  function renderDbEntry(dbItem) {
    ...
    var dashboardLink = dbItem.dashboard ? '<a href="' + safeUrl(dbItem.dashboard) + '" class="db-dashboard-link">\u30c0\u30c3\u30b7\u30e5\u30dc\u30fc\u30c9 &rarr;</a>' : '';
    return '<div class="db-entry"><div class="db-entry-header">' +
      ...
      (dashboardLink ? '<div style="margin-top:10px">' + dashboardLink + '</div>' : '') + '</div>';
  }
});
