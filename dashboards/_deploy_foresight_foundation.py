"""Deploy foresight-foundation.html to journal.emerging-future.org/future-design/ via FTP.

Target URL: https://journal.emerging-future.org/future-design/
Remote path: /journal.emerging-future.org/future-design/index.html
"""
import subprocess
import sys
...
LOCAL = Path("/Users/nishimura+/projects/apps/miratuku-news-v2/dashboards/foresight-foundation.html")
REMOTE_DIR = "/journal.emerging-future.org/future-design"
...
def main():
    ...
    ftp.quit()
    print("\nDone.")
    print("\nPublic URL: https://journal.emerging-future.org/future-design/")
