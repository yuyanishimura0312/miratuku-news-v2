"""Deploy future-questions-book.html to journal.emerging-future.org via FTP.

Target URL: https://journal.emerging-future.org/future-questions/
Remote path: /journal.emerging-future.org/future-questions/index.html
"""
import subprocess
import sys
...
LOCAL = Path("/Users/nishimura+/projects/apps/miratuku-news-v2/dashboards/ryoiki/phase-e/future-questions-book.html")
REMOTE_DIR = "/journal.emerging-future.org/future-questions"
...
def main():
    ...
    ftp.quit()
    print("\nDone.")
    print(f"\nPublic URL: https://journal.emerging-future.org/future-questions/")
