"""Deploy data-driven-foresight/index.html to journal.emerging-future.org via FTP.

Target URL: https://journal.emerging-future.org/deep-knowledge-foresight/
Remote path: /journal.emerging-future.org/deep-knowledge-foresight/index.html
"""
import subprocess
import sys
...
LOCAL = Path("/Users/nishimura+/projects/apps/miratuku-news-v2/dashboards/data-driven-foresight/index.html")
REMOTE_DIR = "/journal.emerging-future.org/deep-knowledge-foresight"
...
def main():
    ...
    ftp.quit()
    print("\nDone.")
    print(f"\nPublic URL: https://journal.emerging-future.org/deep-knowledge-foresight/")
